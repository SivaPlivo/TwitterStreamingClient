...
public class DataManager {
    ...
    fileprivate static let modelURL: URL = Bundle(for: DataManager.self).url(forResource: "StreamsDataModel", withExtension: "momd")!
    ...
    fileprivate static let sqliteURL: URL = {
        ...
        return documentsDirectory.appendingPathComponent("StreamsDataModel.sqlite")
    }()
