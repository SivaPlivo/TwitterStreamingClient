 ...
 */
class FeedViewModel: NSObject, MVVMBinding, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    /// Max number of items visible on screen
    fileprivate static let batchLimit: Int = 5
